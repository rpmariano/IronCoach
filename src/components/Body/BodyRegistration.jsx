  ...
  return (
    <div className="space-y-4 fade-in">
      <div
        ...
        // cima, bem subtil.
        style={{
          background: 'linear-gradient(135deg, color-mix(in srgb, var(--mod-corpo-to) 3%, transparent), color-mix(in srgb, var(--mod-corpo-to) 6%, transparent)), rgba(255, 255, 255, 0.05)',
        }}
      >
