      ...
      <div className="card rounded-2xl p-4">
        ...
        <div className="flex items-center gap-4 mt-6 pt-4 border-t border-[var(--border-faint)] px-1">
          <span className="flex items-center gap-1.5 text-[11px] text-[var(--text-3)]">
            <span className="w-2 h-2 rounded-full bg-[var(--ok)]"></span> Avaliação registada
          </span>
        </div>
      </div>
      ...
      <div className="mt-6">
        ...
        <div className="space-y-2">
          {dayAssessments.length === 0 ? (
            <p className="text-xs text-[var(--text-3)] text-center py-6">Sem avaliações registadas neste dia.</p>
          ) : (
