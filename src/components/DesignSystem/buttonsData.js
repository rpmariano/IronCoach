export const buttonsData = [
  {
    ...
    "sampleText": "setActiveTab(t.key)}\n            className={`shrink-0 flex items-center gap-1.5 border border-[var(--border-glass-strong)] rounded-xl py-2 px-3 text-xs font-semibold transition ${\n              activeTab === t.key ? 'bg-[var(--accent)] shadow-md' : 'text-[var(--text-3)] hover:text-[var(--text-2)] bg-[var(--surface-glass)]'\n            }`}\n            style={activeTab === t.key ? { color: '#fff' } : undefined}\n          >\n             {t.label}"
  },
  {
    "className": "tap-44 flex items-center justify-center text-[var(--text-3)] hover:text-[var(--text-1)] transition",
    "count": 6,
    "files": [
    ...
    "sampleText": "setCurrentDate(subMonths(currentDate, 1))} className=\"tap-44 flex items-center justify-center text-[var(--text-3)] hover:text-[var(--text-1)] transition\">"
  },
  {
    "className": "tap-44 text-[var(--text-3)] hover:text-[var(--text-3)] shrink-0",
    "count": 4,
    "files": [
  ...
  {
    "className": "flex-1 bg-[var(--surface-faint)] border border-[var(--border-glass)] hover:bg-[var(--surface-soft)] text-[var(--text-2)] font-semibold text-xs rounded-xl py-2.5 flex items-center justify-center gap-1.5 transition",
    "count": 4,
    "files": [
      "\\components\\Body\\BodyAssessmentCard.jsx",
      "\\components\\Gym\\GymSessionCard.jsx",
  ...
  {
    "className": "flex-1 border border-[var(--tint-danger-bd)] bg-[var(--tint-danger-bg)] hover:bg-[var(--tint-danger-bg)] text-[var(--danger)] font-bold text-xs rounded-xl py-2.5 flex items-center justify-center gap-1.5 transition disabled:opacity-50",
    "count": 4,
    "files": [
      "\\components\\Body\\BodyAssessmentCard.jsx",
      "\\components\\Gym\\GymSessionCard.jsx",
  ...
  {
    "className": "w-7 h-7 bg-[var(--surface-faint)] rounded-full flex items-center justify-center shadow-sm text-[var(--accent)] disabled:opacity-30",
    "count": 4,
    "files": [
  ...
  {
    "className": "text-[12px] text-[var(--text-3)] hover:text-[var(--danger)] transition font-medium",
    "count": 3,
    "files": [
  ...
  },
  {
    ...
    "sampleText": "scrollTo(idx)}\r\n              aria-label={`Ver cartão ${idx + 1}`}\r\n              className={`h-1.5 shrink-0 rounded-full transition-all duration-300 ${idx === currentIndex ? 'w-4 bg-[var(--accent)]' : 'w-1.5 bg-[var(--accent)] opacity-30'}`}\r\n            />\r\n          ))}\r\n        \r\n        \r\n           scrollTo(Math.max(0, currentIndex - 1))}\r\n            disabled={currentIndex === 0}\r\n            className=\"w-7 h-7 bg-[var(--surface-faint)] rounded-full flex items-center justify-center shadow-sm text-[var(--text-3)] disabled:opacity-30\"\r\n          >"
  },
  {
  ...
  {
    "className": "w-full py-3 rounded-xl font-semibold text-xs text-[var(--text-3)] hover:text-[var(--text-2)] transition disabled:opacity-60",
    "count": 3,
    "files": [
      "\\components\\Perfil\\Perfil.jsx",
  ...
  {
    "className": "w-9 h-9 flex items-center justify-center rounded-full border border-white/60 bg-[var(--surface-glass)] text-[var(--text-3)] hover:text-[var(--text-1)] hover:bg-[var(--surface-faint)] transition shadow-sm",
    "count": 2,
    "files": [
      "\\components\\Calendar\\Calendar.jsx"
    ],
    "sampleText": "setCurrentDate(subMonths(currentDate, 1))} className=\"w-9 h-9 flex items-center justify-center rounded-full border border-white/60 bg-[var(--surface-glass)] text-[var(--text-3)] hover:text-[var(--text-1)] hover:bg-[var(--surface-faint)] transition shadow-sm\">"
  },
  {
    "className": "text-[11px] font-medium text-[var(--text-3)] hover:text-[var(--text-1)] active:scale-95 transition-all shrink-0",
    "count": 2,
    "files": [
  ...
  {
    "className": "rounded-full px-3.5 py-1.5 text-[11px] font-medium border border-dashed border-[var(--border-glass-strong)] text-[var(--text-3)]",
    "count": 2,
    "files": [
      "\\components\\Gym\\GymRegistration.jsx"
    ],
  ...
  {
    "className": "text-[var(--text-3)] hover:text-[var(--danger)] shrink-0",
    "count": 2,
    "files": [
      "\\components\\Gym\\GymRegistration.jsx"
    ],
    "sampleText": "removeExercise(ex.key)} type=\"button\" className=\"text-[var(--text-3)] hover:text-[var(--danger)] shrink-0\">"
  },
  {
  ...
  {
    "className": "w-full py-3 rounded-xl font-semibold text-xs border border-[var(--tint-danger-bd)] text-[var(--danger)] hover:bg-[var(--tint-danger-bg)] transition disabled:opacity-60",
    "count": 2,
    "files": [
      "\\components\\Perfil\\Perfil.jsx",
      "\\components\\Run\\RunAgenda.jsx"
  ...
  {
    "className": "tap-44 flex items-center justify-center text-[var(--text-3)] hover:text-[var(--text-2)]",
    "count": 2,
    "files": [
      "\\components\\Run\\RunCalendar.jsx"
    ],
    "sampleText": "changeMonth(-1)} className=\"tap-44 flex items-center justify-center text-[var(--text-3)] hover:text-[var(--text-2)]\">"
  },
  {
  ...
  {
    "className": "text-[11px] bg-[var(--surface-strong)] px-3 py-1.5 rounded-lg text-[var(--text-3)] font-semibold active:scale-95",
    "count": 1,
    "files": [
      "\\components\\Admin\\Admin.jsx"
    ],
  ...
  {
    "className": "w-full flex items-center justify-center gap-1.5 bg-[var(--surface-strong)] hover:bg-[var(--surface-glass-hover)] active:scale-98 text-xs font-semibold py-2 px-3 rounded-xl text-[var(--text-2)] transition border border-[var(--border-glass-strong)]",
    "count": 1,
    "files": [
      "\\components\\Admin\\Admin.jsx"
    ],
  ...
  {
    "className": "p-1.5 rounded-full bg-[var(--surface-strong)] text-[var(--text-3)] hover:text-[var(--text-2)]",
    "count": 1,
    "files": [
      "\\components\\Admin\\Admin.jsx"
    ],
  ...
  {
    "className": "flex-1 py-2.5 rounded-xl border border-[var(--border-glass-strong)] text-xs font-semibold text-[var(--text-3)] hover:bg-[var(--surface-strong)]",
    "count": 1,
    "files": [
      "\\components\\Admin\\Admin.jsx"
    ],
  ...
  {
    "className": "flex-1 border border-[var(--border-glass-strong)] rounded-xl py-2 text-xs font-semibold transition ${metricsRange === r ? 'bg-[var(--accent)]' : 'text-[var(--text-3)]",
    "count": 1,
    "files": [
      "\\components\\Admin\\Admin.jsx"
    ],
  ...
  {
    "className": "flex-1 border border-[var(--border-glass-strong)] rounded-xl py-2 text-xs font-semibold transition ${costRange === r ? 'bg-[var(--accent)]' : 'text-[var(--text-3)]",
    "count": 1,
    "files": [
      "\\components\\Admin\\Admin.jsx"
    ],
  ...
  {
    "className": "w-full bg-[var(--accent)] text-[var(--text-1)] font-bold text-sm rounded-xl py-3 flex items-center justify-center gap-2 active:scale-[0.98] transition disabled:opacity-50 shadow-sm",
    "count": 1,
    "files": [
  ...
  {
    "className": "w-full bg-[var(--surface-faint)] border border-[var(--border-glass)] rounded-xl py-2.5 text-xs font-semibold text-[var(--text-2)] flex items-center justify-center gap-2 hover:bg-[var(--surface-soft)] active:scale-[0.98] transition shadow-xs",
    "count": 1,
    "files": [
      "\\components\\Auth\\Auth.jsx"
    ],
  ...
  {
    "className": "w-full text-center text-xs text-[var(--text-3)] hover:text-[var(--text-2)] transition pt-1",
    "count": 1,
    "files": [
      "\\components\\Auth\\Auth.jsx"
    ],
  ...
  {
    "className": "flex-1 rounded-xl px-3 py-2.5 text-[12px] font-semibold flex items-center justify-center gap-1.5 border transition ${entryMethod === 'foto' ? 'bg-[var(--mod-corpo-to)] border-[var(--mod-corpo-to)]' : 'bg-[var(--surface-faint)] border-[var(--border-glass)] text-[var(--text-3)]",
    "count": 1,
    "files": [
      "\\components\\Body\\BodyRegistration.jsx"
    ],
  ...
  {
    "className": "flex-1 rounded-xl px-3 py-2.5 text-[12px] font-semibold flex items-center justify-center gap-1.5 border transition ${entryMethod === 'manual' ? 'bg-[var(--mod-corpo-to)] border-[var(--mod-corpo-to)]' : 'bg-[var(--surface-faint)] border-[var(--border-glass)] text-[var(--text-3)]",
    "count": 1,
    "files": [
      "\\components\\Body\\BodyRegistration.jsx"
    ],
  ...
  },
  {
    ...
    "sampleText": "setSelectedDate(date)}\r\n                  className={`w-[42px] h-[46px] rounded-xl flex flex-col items-center justify-between py-1.5 border transition cursor-pointer outline-none ${\r\n                    isSelected \r\n                      ? 'bg-[var(--surface-faint)] border-[var(--border-glass)] text-[var(--text-1)] shadow-[0_4px_15px_rgba(0,0,0,0.05)] scale-[1.02] font-black' \r\n                      : 'bg-[var(--surface-glass)] border-white/70 text-[var(--text-3)] hover:bg-[var(--surface-glass-hover)]'\r\n                  }`}\r\n                >\r\n                  {dayNum}\r\n                  \r\n                    {dayRuns.length > 0 && }\r\n                    {dayGym.length > 0 && }\r\n                    {dayMeals.length > 0 && }\r\n                    {dayBody.length > 0 && }\r\n                    \r\n                    {!dayRuns.length && !dayGym.length && !dayMeals.length && !dayBody.length && isSelected && (\r\n                       \r\n                    )}"
  },
  {
    "className": "text-[11px] text-[var(--text-3)] border border-[var(--border-glass)] rounded-xl px-2.5 py-1 hover:bg-[var(--surface-strong)] active:scale-95 transition flex items-center gap-1",
    "count": 1,
    "files": [
  ...
  {
    "className": "flex-1 border border-[var(--border-glass)] text-[var(--text-3)] text-xs font-semibold rounded-xl py-2.5 hover:bg-[var(--surface-strong)] transition",
    "count": 1,
    "files": [
      "\\components\\Coach\\Coach.jsx"
    ],
  ...
  {
    "className": "flex-1 bg-[var(--tint-danger-bg)] text-[var(--danger)] text-xs font-semibold rounded-xl py-2.5 border border-[var(--tint-danger-bd)] hover:bg-[var(--tint-danger-bg)] transition",
    "count": 1,
    "files": [
      "\\components\\Coach\\Coach.jsx"
    ],
  ...
  {
    "className": "py-2.5 px-3 rounded-xl font-semibold text-xs text-[var(--text-3)] hover:text-[var(--danger)] bg-[var(--surface-faint)] border border-[var(--border-glass)] flex items-center justify-center gap-1 transition active:scale-95",
    "count": 1,
    "files": [
      "\\components\\Coach\\PlanProposalBottomSheet.jsx"
    ],
  ...
  {
    "className": "py-3.5 px-4 rounded-2xl font-semibold text-sm text-[var(--text-3)] hover:text-rose-600 bg-[var(--surface-soft)] hover:bg-[var(--tint-danger-bg)] border border-[var(--border-glass)] hover:border-[var(--tint-danger-bd)] flex items-center justify-center gap-1.5 transition active:scale-95",
    "count": 1,
    "files": [
      "\\components\\Coach\\PlanProposalBottomSheet.jsx"
    ],
  ...
  {
    "className": "flex-1 rounded-xl py-2.5 text-xs font-semibold flex items-center justify-center gap-1.5 transition-colors border ${isActive ? 'bg-[var(--mod-ginasio-to)] border-[var(--mod-ginasio-to)] shadow-sm' : 'bg-[var(--surface-soft)] border-[var(--border-glass)] text-[var(--text-3)]",
    "count": 1,
    "files": [
      "\\components\\Gym\\GymRegistration.jsx"
    ],
  ...
  {
    "className": "rounded-full px-3.5 py-1.5 text-[11px] font-medium border transition-colors ${categories.includes(c) ? 'bg-sky-50 border-[var(--tint-run-bd)] text-[var(--run)]' : 'bg-[var(--surface-faint)] border-[var(--border-glass)] text-[var(--text-3)]",
    "count": 1,
    "files": [
      "\\components\\Gym\\GymRegistration.jsx"
    ],
  ...
  {
    "className": "bg-sky-50 border border-[var(--tint-run-bd)] text-[var(--run)] rounded-full px-3.5 py-1.5 text-[11px] font-medium",
    "count": 1,
    "files": [
      "\\components\\Gym\\GymRegistration.jsx"
    ],
  ...
  {
    "className": "flex-1 rounded-xl px-3 py-2.5 text-[12px] font-semibold flex items-center justify-center gap-1.5 border transition ${entryMethod === 'foto' ? 'bg-[var(--mod-ginasio-to)] border-[var(--mod-ginasio-to)]' : 'bg-[var(--surface-faint)] border-[var(--border-glass)] text-[var(--text-3)]",
    "count": 1,
    "files": [
      "\\components\\Gym\\GymRegistration.jsx"
    ],
  ...
  {
    "className": "flex-1 rounded-xl px-3 py-2.5 text-[12px] font-semibold flex items-center justify-center gap-1.5 border transition ${entryMethod === 'manual' ? 'bg-[var(--mod-ginasio-to)] border-[var(--mod-ginasio-to)]' : 'bg-[var(--surface-faint)] border-[var(--border-glass)] text-[var(--text-3)]",
    "count": 1,
    "files": [
      "\\components\\Gym\\GymRegistration.jsx"
    ],
  ...
  {
    "className": "w-7 h-7 bg-[var(--surface-faint)] rounded-full flex items-center justify-center shadow-sm text-[var(--text-3)] hover:text-[var(--coach)] disabled:opacity-30 transition",
    "count": 1,
    "files": [
      "\\components\\Home\\CoachDailySummaryCard.jsx"
    ],
  ...
  {
    "className": "w-7 h-7 bg-[var(--surface-faint)] rounded-full flex items-center justify-center shadow-sm text-[var(--coach)] disabled:opacity-30 transition",
    "count": 1,
    "files": [
      "\\components\\Home\\CoachDailySummaryCard.jsx"
    ],
  ...
  {
    "className": "absolute left-1/2 -translate-x-1/2 w-14 h-14 rounded-full flex items-center justify-center active:scale-95 transition-all bg-[var(--fab-bg)] border-[4px] border-white ring-[2.5px] ring-slate-900 shadow-xl text-[var(--text-1)] z-50 cursor-pointer",
    "count": 1,
    "files": [
      "\\components\\Layout\\Layout.jsx"
    ],
  ...
  {
    "className": "flex items-center gap-3 pl-2.5 pr-4 py-2 min-h-[44px] rounded-full bg-[var(--surface-faint)] border border-[var(--border-glass)] shadow-md hover:shadow-lg active:scale-95 transition-transform cursor-pointer",
    "count": 1,
    "files": [
      "\\components\\Layout\\Layout.jsx"
    ],
  ...
  {
    "className": "flex-1 rounded-xl px-3 py-2.5 text-[12px] font-semibold flex items-center justify-center gap-1.5 border transition ${entryMethod === 'foto' ? 'bg-[var(--mod-nutricao-to)] border-[var(--mod-nutricao-to)]' : 'bg-[var(--surface-faint)] border-[var(--border-glass)] text-[var(--text-3)]",
    "count": 1,
    "files": [
      "\\components\\Nutrition\\MealRegistration.jsx"
    ],
  ...
  {
    "className": "flex-1 rounded-xl px-3 py-2.5 text-[12px] font-semibold flex items-center justify-center gap-1.5 border transition ${entryMethod === 'manual' ? 'bg-[var(--mod-nutricao-to)] border-[var(--mod-nutricao-to)]' : 'bg-[var(--surface-faint)] border-[var(--border-glass)] text-[var(--text-3)]",
    "count": 1,
    "files": [
      "\\components\\Nutrition\\MealRegistration.jsx"
    ],
  ...
  {
    "className": "text-[11px] text-[var(--text-3)] hover:text-[var(--danger)] flex items-center gap-1 transition",
    "count": 1,
    "files": [
      "\\components\\Nutrition\\MealRegistration.jsx"
    ],
  ...
  {
    "className": "w-full flex items-center justify-between p-4 text-left hover:bg-[var(--surface-soft)] transition",
    "count": 1,
    "files": [
      "\\components\\Nutrition\\NutritionDashboard.jsx"
    ],
  ...
  {
    "className": "w-full border border-[var(--tint-danger-bd)] text-[var(--danger)] text-xs font-semibold rounded-xl py-2.5 flex items-center justify-center gap-1.5 hover:bg-[var(--tint-danger-bg)] transition",
    "count": 1,
    "files": [
      "\\components\\Perfil\\Perfil.jsx"
    ],
  ...
  {
    "className": "w-11 h-6 rounded-full relative transition shrink-0 disabled:opacity-60 ${draft.water_reminder_enabled ? 'bg-[var(--accent)]' : 'bg-[var(--surface-glass-hover)]",
    "count": 1,
    "files": [
      "\\components\\Perfil\\Perfil.jsx"
    ],
  ...
  },
  {
    ...
    "sampleText": "{ setGoalsRationale(''); updateDraft('goals_rationale', null); }} className=\"absolute top-3 right-3 text-[var(--text-3)] hover:text-white\">"
  },
  {
  ...
  {
    "className": "w-full bg-[var(--surface-faint)] text-[var(--text-1)] font-bold text-sm rounded-2xl py-3.5 px-4 border border-[var(--border-glass)] flex items-center justify-center gap-2 hover:bg-[var(--surface-soft)] active:scale-[0.98] transition shadow-sm",
    "count": 1,
    "files": [
      "\\components\\Run\\MissingMetricsBottomSheet.jsx"
    ],
  ...
  {
    "className": "w-full text-[var(--text-3)] font-semibold text-xs py-3 flex items-center justify-center gap-1.5 hover:text-[var(--text-2)] transition",
    "count": 1,
    "files": [
      "\\components\\Run\\MissingMetricsBottomSheet.jsx"
    ],
  ...
  {
    "className": "tap-44 text-[var(--text-3)] hover:text-[var(--ok)] transition",
    "count": 1,
    "files": [
      "\\components\\Run\\RunAgenda.jsx"
    ],
    "sampleText": "handleToggleStatus(ev)} aria-label={done ? 'Marcar prova como agendada' : 'Marcar prova como concluída'} className=\"tap-44 text-[var(--text-3)] hover:text-[var(--ok)] transition\">\r\n              {done ?  : }"
  },
  {
    "className": "tap-44 text-[var(--text-3)] hover:text-[var(--accent)] transition",
    "count": 1,
    "files": [
      "\\components\\Run\\RunAgenda.jsx"
    ],
    "sampleText": "handleOpenForm(ev.id)} aria-label=\"Editar prova\" className=\"tap-44 text-[var(--text-3)] hover:text-[var(--accent)] transition\">"
  },
  {
    ...
    "sampleText": "handleDeleteClick(ev.id)} aria-label=\"Eliminar prova\" className=\"tap-44 text-[var(--text-3)] hover:text-[var(--danger)] transition\">"
  },
  {
    "className": "border border-[var(--border-glass)] text-[var(--text-3)] text-xs font-semibold rounded-lg py-2 hover:bg-[var(--surface-soft)] transition",
    "count": 1,
    "files": [
      "\\components\\Run\\RunAgenda.jsx"
    ],
  ...
  {
    "className": "flex-1 bg-[var(--surface-faint)] border border-[var(--border-glass)] hover:bg-[var(--surface-soft)] text-[var(--text-2)] font-semibold text-xs rounded-xl py-2.5 flex items-center justify-center gap-1.5 transition disabled:opacity-50",
    "count": 1,
    "files": [
      "\\components\\Run\\RunCard.jsx"
    ],
  ...
  {
    "className": "text-[11px] text-[var(--text-3)] hover:text-[var(--danger)] transition",
    "count": 1,
    "files": [
      "\\components\\Run\\RunRegistration.jsx"
    ],
    "sampleText": "{ if (isFormDirty) setShowUnsavedModal(true); else onClose(); }} className=\"text-[11px] text-[var(--text-3)] hover:text-[var(--danger)] transition\">Cancelar"
  },
  {
    "className": "rounded-full px-3 py-1.5 text-[11px] font-medium transition border ${runKind === 'treino' ? 'bg-[var(--mod-corrida-to)] border-[var(--mod-corrida-to)]' : 'bg-[var(--surface-faint)] border-[var(--border-glass)] text-[var(--text-3)]",
    "count": 1,
    "files": [
      "\\components\\Run\\RunRegistration.jsx"
    ],
  ...
  {
    "className": "rounded-full px-3 py-1.5 text-[11px] font-medium transition border ${runKind === 'competicao' ? 'bg-[var(--mod-corrida-to)] border-[var(--mod-corrida-to)]' : 'bg-[var(--surface-faint)] border-[var(--border-glass)] text-[var(--text-3)]",
    "count": 1,
    "files": [
      "\\components\\Run\\RunRegistration.jsx"
    ],
  ...
  {
    "className": "flex-1 aspect-square rounded-lg flex items-center justify-center text-[13px] font-bold transition-colors border shadow-sm ${runEffortRpe === i + 1 ? 'bg-[var(--mod-corrida-to)] border-[var(--mod-corrida-to)]' : 'bg-[var(--surface-faint)] border-[var(--border-glass)] text-[var(--text-3)]",
    "count": 1,
    "files": [
      "\\components\\Run\\RunRegistration.jsx"
    ],
  ...
  {
    "className": "flex-1 rounded-xl px-3 py-2.5 text-[12px] font-semibold flex items-center justify-center gap-1.5 border transition ${entryMethod === 'foto' ? 'bg-[var(--mod-corrida-to)] border-[var(--mod-corrida-to)]' : 'bg-[var(--surface-faint)] border-[var(--border-glass)] text-[var(--text-3)]",
    "count": 1,
    "files": [
      "\\components\\Run\\RunRegistration.jsx"
    ],
  ...
  {
    "className": "flex-1 rounded-xl px-3 py-2.5 text-[12px] font-semibold flex items-center justify-center gap-1.5 border transition ${entryMethod === 'manual' ? 'bg-[var(--mod-corrida-to)] border-[var(--mod-corrida-to)]' : 'bg-[var(--surface-faint)] border-[var(--border-glass)] text-[var(--text-3)]",
    "count": 1,
    "files": [
      "\\components\\Run\\RunRegistration.jsx"
    ],
  ...
  {
    "className": "absolute top-1 right-1 bg-[var(--bg-scrim)] rounded-full p-1 hover:bg-[var(--danger)] transition",
    "count": 1,
    "files": [
      "\\components\\Run\\RunRegistration.jsx"
    ],
    "sampleText": "removePhoto(i)} style={{ color: '#fff' }} className=\"absolute top-1 right-1 bg-[var(--bg-scrim)] rounded-full p-1 hover:bg-[var(--danger)] transition\">"
  },
  {
    "className": "text-[11px] text-[var(--text-3)] hover:text-[var(--danger)] flex items-center gap-1 transition",
    "count": 1,
    ...
    "sampleText": "setRunPhotos([])} className=\"text-[11px] text-[var(--text-3)] hover:text-[var(--danger)] flex items-center gap-1 transition\">\r\n                       Limpar todos"
  },
  {
  ...
  {
    "className": "p-1 text-[var(--text-3)] hover:text-[var(--danger)]",
    "count": 1,
    "files": [
      "\\components\\Run\\RunRegistration.jsx"
    ],
  ...
  {
    "className": "fixed bottom-20 right-5 z-[90] bg-[var(--race)] hover:bg-[var(--race-deep)] text-white font-bold text-xs rounded-full px-3.5 py-2.5 shadow-lg flex items-center gap-1.5 transition active:scale-95 animate-bounce",
    "count": 1,
    "files": [
      "\\components\\Run\\RunRegistration.jsx"
    ],
  ...
  {
    "className": "w-full flex items-center justify-center gap-2 py-3 rounded-xl font-semibold text-xs border border-[var(--tint-danger-bd)] text-[var(--danger)] hover:bg-[var(--tint-danger-bg)] transition disabled:opacity-60",
    "count": 1,
    "files": [
      "\\components\\shared\\ConfirmDeleteModal.jsx"
    ],
  ...
  {
    "className": "w-full py-3 rounded-xl font-semibold text-xs border border-[var(--tint-danger-bd)] text-[var(--danger)] hover:bg-rose-500/10 transition disabled:opacity-60",
    "count": 1,
    "files": [
      "\\components\\shared\\UnsavedChangesModal.jsx"
    ],
  ...
  {
    "className": "w-full py-2.5 rounded-xl font-semibold text-xs text-[var(--text-3)] hover:text-[var(--text-2)] transition disabled:opacity-60",
    "count": 1,
    "files": [
      "\\components\\shared\\UnsavedChangesModal.jsx"
    ],
