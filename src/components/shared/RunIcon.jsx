...
export default function RunIcon({ className = "w-5 h-5", size, color, strokeWidth = 2, ...props }) {
  // Support lucide-react like props (size, color, strokeWidth)
  const finalClassName = size ? undefined : className;
