...
const TONE = {
  critical: { Icon: AlertTriangle, color: 'var(--danger)', bg: 'var(--tint-danger-bg)', bd: 'var(--tint-danger-bd)', text: 'var(--danger-soft)', btnBg: 'rgba(248,113,113,.18)', btnColor: 'var(--danger)' },
