...
export default function FirstDayCard({ firstName, goal = null, facts = [], vida = null, notesLoaded = true, onTalk, onCreateRace, onRegisterRun, onRegisterMeal }) {
  ...
  const ask = firstDayAsk(goal, firstName, { vida, notasLidas: notesLoaded });
  // Com as notas ainda a chegar não há pedido: só o avatar e o olá (firstDayAsk).
  const aLer = !ask.primary;
