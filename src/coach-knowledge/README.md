...
| 8 — Nível por prova / trail | ⚠️ Parcial — `categorizeElevationRatio()`, invalidação do nível, `assessRaceLevelTriage()`, `RaceLevelSuggestion.jsx` e `ExperienceLevelHelp.jsx` com `context='prova'` implementados e testados; falta o consumo no `coach-chat` — ver [specs/nivel-por-prova.md](../../specs/nivel-por-prova.md) |
