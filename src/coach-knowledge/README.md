...
| 8 — Nível por prova / trail | ⚠️ Parcial — `categorizeElevationRatio()`, invalidação do nível, `assessRaceLevelTriage()`, `RaceLevelSuggestion.jsx` e agora `ExperienceLevelHelp.jsx` com `context='prova'` (tabela por categoria de distância/trail) implementados e testados; falta o consumo no `coach-chat` e o campo de passadeira — ver [specs/nivel-por-prova.md](../../specs/nivel-por-prova.md) |
