...
| 8 — Nível por prova / trail | ⚠️ Parcial — `categorizeElevationRatio()`, invalidação do nível, `assessRaceLevelTriage()` e agora `RaceLevelSuggestion.jsx` (proposta de nível com evidência, ligada ao formulário) implementados e testados; falta a tabela do help por categoria em `ExperienceLevelHelp.jsx` e o consumo no `coach-chat` — ver [specs/nivel-por-prova.md](../../specs/nivel-por-prova.md) |
