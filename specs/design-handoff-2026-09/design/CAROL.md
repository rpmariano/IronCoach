...
- **Desenho:** retrato de traço simples, dentro do disco ciano dela — linha escura, cara clara, bochechas coradas, e o cabelo numa silhueta sólida da mesma tinta: franja reta, cortada a direito acima das sobrancelhas, e rabo-de-cavalo alto com as pontas desfiadas. Só a cabeça: o pescoço sai pelo fundo do disco e os ombros nunca aparecem. Sempre o mesmo; muda a expressão, nunca a pessoa.
...
- **Tamanhos:** funciona de 24 px a 88 px. Abaixo de 32 px o enquadramento aproxima-se da cara; acima de 56 px entram o nariz e um fio de luz no rabo-de-cavalo.
