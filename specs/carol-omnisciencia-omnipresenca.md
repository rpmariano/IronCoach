...
- **Um momento desligado no Perfil não esconde os seguintes.** Por exemplo, com o balanço desligado, o "Estás bem?" ainda pode sair. A exceção é o balanço da semana (P.14): um momento desligado que se aplique continua a ficar com o dia, e o balanço não sai no lugar dele.
